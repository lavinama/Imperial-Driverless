...
from .track_generator import GeneratorContext, TrackGenerator as Generator
from .track import Track

class IDTrackGenerator(Plugin):
    ...
    def __init__(self, context):
        """
                ...
                """
        super(IDTrackGenerator, self).__init__(context)
        ...
        # this package
        self.main_ui_file = join(get_package_share_directory('id_track_utils'),
                                 'resource',
                                 'track_generator.ui',
                                 )
        ...
        self.TRACKS = get_package_share_directory('id_track_utils')
    ...
    def copy_button_pressed(self):
        ...
        if ending == "launch":
            model_path = join(
                get_package_share_directory('id_track_utils'),
                'models',
                raw_name_to
            )
    ...
    def update_converter_dropdown(self):
        ...
        if from_type == "launch":
            # Get tracks from id_track_utils package
            relevant_path = join(
                self.TRACKS,
                'launch'
            )
