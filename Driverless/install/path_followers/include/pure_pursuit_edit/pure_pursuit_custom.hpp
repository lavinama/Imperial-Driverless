...
#ifndef pure_pursuit_edit__REGULATED_PURE_PURSUIT_CONTROLLER_HPP_
#define pure_pursuit_edit__REGULATED_PURE_PURSUIT_CONTROLLER_HPP_
...
namespace pure_pursuit_edit
{

/**
 * @class pure_pursuit_edit::RegulatedPurePursuitController
...
public:
  /**
   * @brief Constructor for pure_pursuit_edit::RegulatedPurePursuitController
   */
  RegulatedPurePursuitController() = default;

  /**
   * @brief Destrructor for pure_pursuit_edit::RegulatedPurePursuitController
   */
...
protected:
  ...
  /**
   * @brief Return the instantaneous turn radius at fixed intervals along the planned path
   * @param max_sample_distance Maximum distance at which to sample
   * @param sample_separation The interval between samples in metres
   * @return pairs of (distance along the path, turn radius)
   */
  std::vector<std::pair<double, double>> samplePlanForTurnRadius(
    const nav_msgs::msg::Path & transformed_plan,
    const double max_sample_distance,
    const double sample_separation);
...
#endif  // pure_pursuit_edit__REGULATED_PURE_PURSUIT_CONTROLLER_HPP_
