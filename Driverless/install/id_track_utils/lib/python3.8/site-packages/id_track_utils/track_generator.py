...
from ._math_utilities import (calculate_tangent_angle, calculate_tangent_vector,
...
class TrackGenerator:
    ...
    def get_preset(name):
        ...
        print("No such preset: " + name)
        print("Defaulting to " + TrackGenerator.get_default_preset())
...
def generate_random_track(start_point):
    ...
    for goal_point in goal_points:
        ...
        if check_if_overlap(test):
            if TrackGenerator.FAILURE_INFO:
                print("Early Overlap Checking: Failed")
